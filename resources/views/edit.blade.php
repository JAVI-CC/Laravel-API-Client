...
<form enctype="multipart/form-data" method="POST" action="{{ url("juegos/edit") }} ">
  ...
  <div class="form-group" style="margin-top: 15px;">
    ...
    <textarea class="form-control input-descripcion" name="descripcion" rows="3" placeholder="Descripción..." maxlength="800" style="@isset($error->descripcion['0']) border-color: red; @endisset">@isset($juego->descripcion){{$juego->descripcion}}@endisset @isset($values['descripcion']){{$values['descripcion']}}@endisset</textarea>
    <div style="margin-top: 5px;"></div>
